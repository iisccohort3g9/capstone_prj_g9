...
async def generate_video(file: UploadFile = File(...)):
    ...
    rfs = ResumeSummary(resume_data, logger, callbacks=callbacks)
    ...
    command = ["python", "Wav2Lip/inference.py", "--checkpoint_path", "Wav2Lip/checkpoints/wav2lip_gan.pth", "--face", "input_video.mp4", "--audio", audio_file_path]
    print(command)
